...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("ssaa_image",{VK_GRAPHICS_BASIC_ROOT"/resources/shaders/quad.frag.spv",
                                      VK_GRAPHICS_BASIC_ROOT"/resources/shaders/quad3_vert.vert.spv"});
}
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    etna::RenderTargetState renderTargets(a_cmdBuff, {2048 * m_scale, 2048 * m_scale}, {}, shadowMap);
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, {m_width * m_scale, m_height * m_scale}, {{bigImage}}, mainViewDepth);
