...
void SimpleShadowmapRender::AllocateResources()
{
  ...
  resImage = m_context->createImage(etna::Image::CreateInfo
   {
    .extent     = vk::Extent3D{ m_width, m_height, 1 },
  ...
  resBlurredImage = m_context->createImage(etna::Image::CreateInfo
  {
    .extent     = vk::Extent3D{ m_width, m_height, 1 },
    .format     = vk::Format::eB8G8R8A8Unorm,
    .imageUsage = (
...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("simple_blur", { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/simple.comp.spv" });
}
...
void SimpleShadowmapRender::SetupSimplePipeline()
{
  ...
  m_blurPipeline = pipelineManager.createComputePipeline("simple_blur", {});
  print_prog_info("simple_material");
  print_prog_info("simple_shadow");
  print_prog_info("simple_blur");
}
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, { m_width, m_height }, { { resImage.getView({}) } }, mainViewDepth.getView({}));
  ...
  if(m_input.drawFSQuad)
  {
    ...
    m_pFSQuad->SetRenderTarget(resImage.getView({}));
  ...
  // blur
  {
    ...
    auto set = etna::create_descriptor_set(simpleBlurInfo.getDescriptorLayoutId(0), { 
      etna::Binding{ 0, vk::DescriptorImageInfo{ defaultSampler.get(), resImage.getView({}), vk::ImageLayout::eGeneral } }, 
      etna::Binding{ 1, vk::DescriptorImageInfo{ defaultSampler.get(), resBlurredImage.getView({}), vk::ImageLayout::eGeneral } } 
      }
    );
    ...
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_COMPUTE, 
      simpleBlurInfo.getPipelineLayout(), 0, 1, &vkSet, 0, VK_NULL_HANDLE);
