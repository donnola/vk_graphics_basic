...
{
  m_pScnMgr->LoadSceneQuadMesh(path, transpose_inst_matrices, pushConst2M.resolution);
...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("generate_fog", {VK_GRAPHICS_BASIC_ROOT"/resources/shaders/fog.frag.spv",
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
...

  {
    ...
    colorAttachmentParams.clearColorValue = std::array<float, 4>({0.f, 0.f, 0.f, 0.f});
