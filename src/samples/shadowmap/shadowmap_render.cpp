...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  {
    etna::set_state(a_cmdBuff, sqVarianceShadowMap.get(),
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, {2048, 2048},
                                          {{sqVarianceShadowMap.get(), sqVarianceShadowMap.getView({})}}, shadowMap);
  ...
  if (m_uniforms.useVSM)
  {
    ...
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_COMPUTE,
      m_vsmCompPipeline.getVkPipelineLayout(), 0, 1, &vkSet, 0, VK_NULL_HANDLE);
