...
void main()
{
  ...
  float lightAngleCos = dot(normalize(Params.lightDir), -lightDir);
  float innerAngleCos = cos(radians(Params.lightInnerAngle));
  float outerAngleCos = cos(radians(Params.lightOuterAngle));
